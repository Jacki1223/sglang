...
| **MiDashengLM** (3B, 7B)   | `Xiaomi/MiDasheng-LM-3B-Chat`              | Xiaomi's audio-language model that combines the Dasheng audio encoder with Qwen2 language model for efficient and comprehensive audio understanding through general audio captions. Supports speech, sound, and music information processing. |  |
