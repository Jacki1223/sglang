...
@triton.autotune(
    configs=[
        # Balanced configs: keep BV=64 but use lower num_warps to reduce resource contention
        # This leaves more SM resources available for AllReduce operations
        triton.Config({}, num_warps=2, num_stages=3),
        triton.Config({}, num_warps=2, num_stages=2),
        triton.Config({}, num_warps=3, num_stages=2),
        # Removed num_warps=4 and num_warps=8 configs to avoid AllReduce blocking
    ],
    key=["BK", "BV", "K", "V"],
)
